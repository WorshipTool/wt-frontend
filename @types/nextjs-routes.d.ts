...
declare module "nextjs-routes" {
  ...
  export type Route =
    ...
    | StaticRoute<"/sub/admin/ke-schvaleni">
    | StaticRoute<"/sub/admin/ml-trenink">
    ...
    | StaticRoute<"/sub/admin/posledni-pridane">
    ...
    | DynamicRoute<"/sub/tymy/[alias]/playlist/[guid]/prezentace", { "alias": string; "guid": string }>
    ...
    | DynamicRoute<"/sub/tymy/brez-pristupu/[alias]", { "alias": string }>
