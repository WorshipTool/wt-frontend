...
declare const messages: {
	...
	"auth": {
		...
		"signup": {
			...
			"subtitle": "A používejte aplikaci naplno",
			"firstName": "Jméno",
			"enterFirstName": "Zadejte vaše jméno",
			"lastName": "Příjmení",
			"enterLastName": "Zadejte vaše příjmení",
			"email": "Email",
			"enterEmail": "Zadejte váš email",
			"password": "Heslo",
			"enterPassword": "Vytvořte si heslo",
			"passwordRequirements": "Heslo musí mít alespoň 8 znaků, obsahovat malé a velké písmeno a číslo",
			"passwordTooShort": "Heslo musí mít alespoň 8 znaků",
			"passwordMissingLowercase": "Heslo musí obsahovat malé písmeno",
			"passwordMissingUppercase": "Heslo musí obsahovat velké písmeno",
			"passwordMissingNumber": "Heslo musí obsahovat číslo",
