 ...
 * 
 * @export
 * @interface GetNewsStateOutDto
 */
export interface GetNewsStateOutDto {
    /**
     * State of all news items for the user
     * @type {Array<NewsUserStateDto>}
     * @memberof GetNewsStateOutDto
     */
    'state': Array<NewsUserStateDto>;
    /**
     * Whether news can be shown (weekly limit)
     * @type {boolean}
     * @memberof GetNewsStateOutDto
     */
    'canShowNews': boolean;
 ...
 * 
 * @export
 * @interface MarkNewsAsSeenInDto
 */
export interface MarkNewsAsSeenInDto {
    /**
     * News item ID
     * @type {string}
     * @memberof MarkNewsAsSeenInDto
     */
    'newsId': string;
}
/**
 * 
 * @export
 * @interface MarkNewsAsTriedInDto
 */
export interface MarkNewsAsTriedInDto {
    /**
     * News item ID
     * @type {string}
     * @memberof MarkNewsAsTriedInDto
     */
    'newsId': string;
}
/**
 ...
 * 
 * @export
 * @interface NewsUserStateDto
 */
export interface NewsUserStateDto {
    /**
     * News item ID
     * @type {string}
     * @memberof NewsUserStateDto
     */
    'newsId': string;
    /**
     * Whether user has seen the news in popup
     * @type {boolean}
     * @memberof NewsUserStateDto
     */
    'seen': boolean;
    /**
     * Whether user has tried the feature associated with the news
     * @type {boolean}
     * @memberof NewsUserStateDto
     */
    'tried': boolean;
    /**
     * Date when user saw the news
     * @type {string}
     * @memberof NewsUserStateDto
     */
    'seenAt'?: string;
...
export const BridgeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBridgeServiceUrlByType: async (type: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'type' is not null or undefined
            assertParamExists('getBridgeServiceUrlByType', 'type', type)
            const localVarPath = `/bridge/service-data/{type}`
         ...
         * @throws {RequiredError}
         */
        trainFamilyMatch: async (trainFamilyMatchDto: TrainFamilyMatchDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'trainFamilyMatchDto' is not null or undefined
            assertParamExists('trainFamilyMatch', 'trainFamilyMatchDto', trainFamilyMatchDto)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(trainFamilyMatchDto, localVarRequestOptions, configuration)
...
export const BridgeApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBridgeServiceUrlByType(type: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetBridgeServiceDataDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBridgeServiceUrlByType(type, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BridgeApi.getBridgeServiceUrlByType']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async trainFamilyMatch(trainFamilyMatchDto: TrainFamilyMatchDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.trainFamilyMatch(trainFamilyMatchDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BridgeApi.trainFamilyMatch']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const BridgeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getBridgeServiceUrlByType(type: string, options?: any): AxiosPromise<GetBridgeServiceDataDto> {
            return localVarFp.getBridgeServiceUrlByType(type, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        trainFamilyMatch(trainFamilyMatchDto: TrainFamilyMatchDto, options?: any): AxiosPromise<object> {
            return localVarFp.trainFamilyMatch(trainFamilyMatchDto, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BridgeApi extends BaseAPI {
     ...
     * @memberof BridgeApi
     */
    public getBridgeServiceUrlByType(type: string, options?: RawAxiosRequestConfig) {
        return BridgeApiFp(this.configuration).getBridgeServiceUrlByType(type, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BridgeApi
     */
    public trainFamilyMatch(trainFamilyMatchDto: TrainFamilyMatchDto, options?: RawAxiosRequestConfig) {
        return BridgeApiFp(this.configuration).trainFamilyMatch(trainFamilyMatchDto, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const NewsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Clears news state for user (for testing/reset).
         * @summary Clears news state for user
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        clearState: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/news/state`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * Returns state of all news items and information about weekly display limit.
         * @summary Gets news state for user
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNewsState: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/news/state`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * Marks a single news item as seen in popup.
         * @summary Marks news item as seen in popup
         * @param {MarkNewsAsSeenInDto} markNewsAsSeenInDto 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        markAsSeen: async (markNewsAsSeenInDto: MarkNewsAsSeenInDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'markNewsAsSeenInDto' is not null or undefined
            assertParamExists('markAsSeen', 'markNewsAsSeenInDto', markNewsAsSeenInDto)
            const localVarPath = `/news/seen`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(markNewsAsSeenInDto, localVarRequestOptions, configuration)
        ...
        /**
         * Marks a news item as tried (user clicked on the component).
         * @summary Marks news item as tried
         * @param {MarkNewsAsTriedInDto} markNewsAsTriedInDto 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        markAsTried: async (markNewsAsTriedInDto: MarkNewsAsTriedInDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'markNewsAsTriedInDto' is not null or undefined
            assertParamExists('markAsTried', 'markNewsAsTriedInDto', markNewsAsTriedInDto)
            const localVarPath = `/news/tried`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(markNewsAsTriedInDto, localVarRequestOptions, configuration)
...
export const NewsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async clearState(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.clearState(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NewsApi.clearState']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns state of all news items and information about weekly display limit.
         ...
         * @throws {RequiredError}
         */
        async getNewsState(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetNewsStateOutDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNewsState(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NewsApi.getNewsState']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Marks a single news item as seen in popup.
         ...
         * @throws {RequiredError}
         */
        async markAsSeen(markNewsAsSeenInDto: MarkNewsAsSeenInDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.markAsSeen(markNewsAsSeenInDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NewsApi.markAsSeen']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Marks a news item as tried (user clicked on the component).
         ...
         * @throws {RequiredError}
         */
        async markAsTried(markNewsAsTriedInDto: MarkNewsAsTriedInDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.markAsTried(markNewsAsTriedInDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NewsApi.markAsTried']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const NewsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        clearState(options?: any): AxiosPromise<void> {
            return localVarFp.clearState(options).then((request) => request(axios, basePath));
        },
        /**
         * Returns state of all news items and information about weekly display limit.
         * @summary Gets news state for user
         ...
         * @throws {RequiredError}
         */
        getNewsState(options?: any): AxiosPromise<GetNewsStateOutDto> {
            return localVarFp.getNewsState(options).then((request) => request(axios, basePath));
        },
        /**
         * Marks a single news item as seen in popup.
         * @summary Marks news item as seen in popup
         ...
         * @throws {RequiredError}
         */
        markAsSeen(markNewsAsSeenInDto: MarkNewsAsSeenInDto, options?: any): AxiosPromise<void> {
            return localVarFp.markAsSeen(markNewsAsSeenInDto, options).then((request) => request(axios, basePath));
        },
        /**
         * Marks a news item as tried (user clicked on the component).
         * @summary Marks news item as tried
         ...
         * @throws {RequiredError}
         */
        markAsTried(markNewsAsTriedInDto: MarkNewsAsTriedInDto, options?: any): AxiosPromise<void> {
            return localVarFp.markAsTried(markNewsAsTriedInDto, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class NewsApi extends BaseAPI {
     ...
     * @memberof NewsApi
     */
    public clearState(options?: RawAxiosRequestConfig) {
        return NewsApiFp(this.configuration).clearState(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof NewsApi
     */
    public getNewsState(options?: RawAxiosRequestConfig) {
        return NewsApiFp(this.configuration).getNewsState(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof NewsApi
     */
    public markAsSeen(markNewsAsSeenInDto: MarkNewsAsSeenInDto, options?: RawAxiosRequestConfig) {
        return NewsApiFp(this.configuration).markAsSeen(markNewsAsSeenInDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof NewsApi
     */
    public markAsTried(markNewsAsTriedInDto: MarkNewsAsTriedInDto, options?: RawAxiosRequestConfig) {
        return NewsApiFp(this.configuration).markAsTried(markNewsAsTriedInDto, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PackEmbeddingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getMostClosestToPack: async (packGuid: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'packGuid' is not null or undefined
            assertParamExists('getMostClosestToPack', 'packGuid', packGuid)
            const localVarPath = `/pack-embedding/getMostClosestToPack`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPackEmbedding: async (packGuid: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'packGuid' is not null or undefined
...
export const PackEmbeddingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMostClosestToPack(packGuid: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMostClosestToPack(packGuid, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PackEmbeddingApi.getMostClosestToPack']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getPackEmbedding(packGuid: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetEmbeddingFromPackOutDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPackEmbedding(packGuid, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PackEmbeddingApi.getPackEmbedding']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const PackEmbeddingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMostClosestToPack(packGuid: string, options?: any): AxiosPromise<void> {
            return localVarFp.getMostClosestToPack(packGuid, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} packGuid 
         ...
         * @throws {RequiredError}
         */
        getPackEmbedding(packGuid: string, options?: any): AxiosPromise<GetEmbeddingFromPackOutDto> {
            return localVarFp.getPackEmbedding(packGuid, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} searchKey 
...
export class PackEmbeddingApi extends BaseAPI {
     ...
     * @memberof PackEmbeddingApi
     */
    public getMostClosestToPack(packGuid: string, options?: RawAxiosRequestConfig) {
        return PackEmbeddingApiFp(this.configuration).getMostClosestToPack(packGuid, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getPackEmbedding(packGuid: string, options?: RawAxiosRequestConfig) {
        return PackEmbeddingApiFp(this.configuration).getPackEmbedding(packGuid, options).then((request) => request(this.axios, this.basePath));
    }
...
export const SongManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        comparePacks: async (compareInDto: CompareInDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(compareInDto, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        separateAllSongs: async (body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SongManagementApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async addAllPacksToFindFamily(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SongManagementApi.addAllPacksToFindFamily']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Add all packs without language to generate
        ...
        async addPackToFindFamily(packGuid: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SongManagementApi.addPackToFindFamily']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async comparePacks(compareInDto: CompareInDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.comparePacks(compareInDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SongManagementApi.comparePacks']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async separateAllSongs(body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.separateAllSongs(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SongManagementApi.separateAllSongs']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const SongManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        comparePacks(compareInDto: CompareInDto, options?: any): AxiosPromise<void> {
            return localVarFp.comparePacks(compareInDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {MergeFamiliesInDto} mergeFamiliesInDto 
        ...
        separateAllSongs(body: object, options?: any): AxiosPromise<void> {
            return localVarFp.separateAllSongs(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} packGuid 
...
export class SongManagementApi extends BaseAPI {
    ...
    public addAllPacksToFindFamily(options?: RawAxiosRequestConfig) {
        return SongManagementApiFp(this.configuration).addAllPacksToFindFamily(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public addPackToFindFamily(packGuid: string, options?: RawAxiosRequestConfig) {
        return SongManagementApiFp(this.configuration).addPackToFindFamily(packGuid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SongManagementApi
     */
    public comparePacks(compareInDto: CompareInDto, options?: RawAxiosRequestConfig) {
        return SongManagementApiFp(this.configuration).comparePacks(compareInDto, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public separateAllSongs(body: object, options?: RawAxiosRequestConfig) {
        return SongManagementApiFp(this.configuration).separateAllSongs(body, options).then((request) => request(this.axios, this.basePath));
    }
